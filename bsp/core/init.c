...
void trap_init()
{
    ...
    scause_interrupt_table[USER_SW_INTERRUPT]        = sdefault_handler;
	scause_interrupt_table[SUPER_SW_INTERRUPT]       = sdefault_handler;
	scause_interrupt_table[RESERVED_INTERRUPT0]      = sdefault_handler;
	scause_interrupt_table[RESERVED_INTERRUPT1]      = sdefault_handler;
	scause_interrupt_table[USER_TIMER_INTERRUPT]     = sdefault_handler;
	scause_interrupt_table[SUPER_TIMER_INTERRUPT]    = sdefault_handler;
	scause_interrupt_table[RESERVED_INTERRUPT2]      = sdefault_handler;
	scause_interrupt_table[RESERVED_INTERRUPT3]      = sdefault_handler;
	scause_interrupt_table[USER_EXT_INTERRUPT]       = sdefault_handler;
	scause_interrupt_table[SUPERVISOR_EXT_INTERRUPT] = sdefault_handler;
	scause_interrupt_table[RESERVED_INTERRUPT4]      = sdefault_handler;
	scause_interrupt_table[RESERVED_INTERRUPT5]      = sdefault_handler;
	scause_interrupt_table[RESERVED_INTERRUPT6]      = sdefault_handler;
	scause_interrupt_table[RESERVED_INTERRUPT7]      = sdefault_handler;
	scause_interrupt_table[RESERVED_INTERRUPT8]      = sdefault_handler;
	scause_interrupt_table[RESERVED_INTERRUPT9]      = sdefault_handler;

	scause_trap_table[INSTRUCTION_ADDRESS_MISALIGNED] =
		sdefault_handler;
	scause_trap_table[INSTRUCTION_ACCESS_FAULT] =
		sdefault_handler;
	scause_trap_table[ILLEGAL_INSTRUCTION] =
		sdefault_handler;
	scause_trap_table[BREAKPOINT] =
		sdefault_handler;
	scause_trap_table[LOAD_ADDRESS_MISALIGNED] =
		sdefault_handler;
	scause_trap_table[LOAD_ACCESS_FAULT] =
		sdefault_handler;
	scause_trap_table[STORE_AMO_ADDRESS_MISALIGNED] =
		sdefault_handler;
	scause_trap_table[STORE_AMO_ACCESS_FAULT] =
		sdefault_handler;
	scause_trap_table[ENVIRONMENT_CALL_FROM_U_MODE] =
		sdefault_handler;
	scause_trap_table[ENVIRONMENT_CALL_FROM_S_MODE] =
		sdefault_handler;
	scause_trap_table[RESERVED_TRAP1] =
		sdefault_handler;
	scause_trap_table[RESERVED_TRAP2] =
		sdefault_handler;
	scause_trap_table[INSTRUCTION_PAGE_FAULT] =
		sdefault_handler;
	scause_trap_table[LOAD_PAGE_FAULT] =
		sdefault_handler;
	scause_trap_table[RESERVED_TRAP3] =
		sdefault_handler;
	scause_trap_table[STORE_AMO_PAGE_FAULT] =
		sdefault_handler;
