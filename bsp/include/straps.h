...
#define RESERVED_INTERRUPT1             3
#define USER_TIMER_INTERRUPT            4
#define SUPER_TIMER_INTERRUPT           5
#define RESERVED_INTERRUPT2             6
#define RESERVED_INTERRUPT3             7
#define USER_EXT_INTERRUPT              8
#define SUPERVISOR_EXT_INTERRUPT        9
#define RESERVED_INTERRUPT4            10
#define RESERVED_INTERRUPT5            11
#define RESERVED_INTERRUPT6            12
#define RESERVED_INTERRUPT7            13
#define RESERVED_INTERRUPT8            14
#define RESERVED_INTERRUPT9            15
...
#define RESERVED_TRAP2                 11
#define INSTRUCTION_PAGE_FAULT         12
#define LOAD_PAGE_FAULT                13
#define RESERVED_TRAP3                 14
...
extern mtrap_fptr_t scause_trap_table[MAX_TRAP_VALUE];
extern mtrap_fptr_t scause_interrupt_table[MAX_INTERRUPT_VALUE];

void sdefault_handler(uintptr_t cause, uintptr_t epc);
unsigned int sextract_ie_code(unsigned int num);
uintptr_t shandle_trap(uintptr_t cause, uintptr_t epc);
